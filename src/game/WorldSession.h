...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    private:
        ...
        bool VerifyMovementInfo(MovementAndPositionInfo const& movementInfo, ObjectGuid const& guid) const;
        void HandleMoverRelocation(MovementAndPositionInfo& movementInfo);
